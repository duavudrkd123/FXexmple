...
// Area Chart....
	...
	public ObservableList<XYChart.Data<String, Integer>> getSeries3() {
		...
		try {
			...
			while(rs.next()) { 
				list.add(new XYChart.Data<>(rs.getNString("receipt_month"),
		...
		ObservableList<XYChart.Data<String, Integer>> list = FXCollections.observableArrayList();
		list.add(new XYChart.Data<String, Integer>("09", 28));
		list.add(new XYChart.Data<String, Integer>("10", 15));
		list.add(new XYChart.Data<String, Integer>("11", 5));
		list.add(new XYChart.Data<String, Integer>("12", 2));
		return list; 
	...
	public ObservableList<XYChart.Data<String, Integer>> getSeries4() {
		ObservableList<XYChart.Data<String, Integer>> list = FXCollections.observableArrayList();
		list.add(new XYChart.Data<String, Integer>("09", 8));
		list.add(new XYChart.Data<String, Integer>("10", 15));
		list.add(new XYChart.Data<String, Integer>("11", 55));
